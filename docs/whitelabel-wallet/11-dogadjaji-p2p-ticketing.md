...
> Datum: 2026-07-16 · Status: **plan** (nijedna faza još nije isporučena) · Jezik: HR + EN sažetak (§9)
...
- **Luma paritet za discovery** (kalendar, subscribe na organizatora, podsjetnici) = E4+, nije
  MVP.
